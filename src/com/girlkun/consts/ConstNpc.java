...
public class ConstNpc {
     public static final String SUKIENHUNGVUONG = "SỰ KIỆN GIỖ TỔ HÙNG VƯƠNG BẮT ĐẦU NGÀY 25/04/2023...\n"
            + "Cách làm sự kiện rất đơn giản nhưng chỉ những ai chịu khó mới làm được...\n"
            + " thu thập các vật phẩm bằng cách Fam quái rơi vật phẩm như xoài-na-đu-đủ-dưa-hấu \n"
            + "sau khi đủ 5 loại quả có thể đổi mâm ngũ quả hoặc mâm ngũ quả có thể đổi tại npc hungvuong...\n"
              + "Mâm ngũ quả có thể sử dụng sẽ nhận được 500k tnsm hoặc dùng để đổi rương sự kiện\n"
            + "Đổi dưa hấu lấy ngọc...\n"
            + "dùng 10 quả dưa hấu để lấy 1 ngọc\n"
             + " Sự kiện không đành cho người lười cân nhắc trước khi chơi...\n";
    ...
    public static final String HUONG_DAN_MOC_NAP = "|1|Mốc 10K: 10V 3sao\b|1|Mốc 20K: 20v 3sao, 20v 7sao\b|1|Mốc 50K: Cải trang Uron, Thần Mini, Búa Mew\b|1|Mốc 100K: 1 Set Kích Hoạt thường, 3 bộ nro\b|1|Mốc 200k: 10 bộ nro torobo, x99(cn,bh,gx,bk), 10 bộ nro\b|1|Mốc 500K: Khủng long tình yêu, Thần Mini, Yumi Misaki, x2000 viên đá các loại\b|1|Mốc 1000K: Khủng long tình yêu, Thần Mini, Sakura Hikari, Dù, nit x99 3sao";
    ...
    public static final byte GHI_DANH = 23;
     public static final byte kichi = 91;
    ...
    public static final byte NOI_BANH = 66;
     public static final byte mai = 88;
     public static final byte nit = 89;
    ...
    public static final int GO_UPSTAIRS_MENU = 10000;
     //index ghi danh dhvt
    public static final int MENU_DHVT = 500;
    ...
    public static final int RUONG_GO = 999;
    ...
    public static final int TUTORIAL_SUMMON_DRAGON = 505;
     public static final int TUTORIAL_SUMMON_DRAGON1 = 2005;
     public static final int SUMMON_SHENRON1 = 2006;
    public static final int SUMMON_SHENRON = 506;
     public static final int SUMMON_BANG= 2002;
    ...
    public static final int MENU_OPTION_USE_ITEM1105 = 1105;
     public static final int sukien = 5089;
    ...
    public static final int SHENRON1_1_1 = 2010;
    public static final int SHENRON1_1_2 =2011;
    public static final int SHENRON1_2 = 2012;
    public static final int SHENRON1_3 = 2013;
      public static final int SHENRON1_CONFIRM = 2014;
