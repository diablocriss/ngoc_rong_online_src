...
public class DataGame {
    ...
    private static final String MOUNT_NUM = "733:1,734:2,735:3,743:4,744:5,746:6,795:7,849:8,897:9,920:10,1250:20,1251:15,1252:16,1253:21";
    ...
    public static void updateMap(MySession session) {
        ...
        try {
            ...
            for (MobTemplate temp : Manager.MOB_TEMPLATES) {
                ...
                msg.writer().writeUTF(temp.name);
                msg.writer().writeInt(Util.TamkjllGH(temp.hp));
